...
* Ingests spatial coordinates for existing Service BC facilities and the proposed pilot location, necessitating a coordinate transformation from WGS 84 to the BC Albers projection (`full-service-bc-locs-wgs84.csv`).
