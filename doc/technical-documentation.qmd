...
### File: settings.R (Global Constants and Configuration) {-}
...
### File: 00-make-data.R (Data Preprocessing) {-}
...
### File: 01a-descriptive-tables.R (Descriptive Statistics){-}
...
### File: 01b-compare-metrics.R (Drive Time vs Distance) {-}
...
### File: 01c-bin-distances.R (Generate Binned Distances) {-}
...
### File: 02a-map-plots.R (Cloropleth Maps) {-}
...
### File: 02b-box-violin-plots.R (Statistical Visualizations) {-}
...
### File: 02c-density-map.R (Smoothed Density Maps) {-}
...
### File:  02d-csd-demographics.R (Additional Demographic Work) {-}
...
### File: 03a-create-catchments.R (Catchment Area Delineation) {-}
...
### File: 03b-plot-catchments.R (Catchment Area Visualization) {-}
...
### File: 03c-sbc-centric-stats.R (Facility-Centric Performance Metrics) {-}
...
### File: 03d-sbc-density-maps.R (Catchment Spatial Density Analysis) {-}
...
### File: 04-sbc-servicebc-catchments.R (Administrative Catchment Mapping) {-}
...
### File: 05a-csd-data-tables.R (CSD Statistics and Demographic Profiling) {-}
...
* The script accounts for minor alignment discrepancies between different geographic data sources by using a complete crosswalk of census-based dissemination blocks.
* Rurality for residents is determined by a 30% area coverage threshold within defined population centers; areas falling below this threshold are flagged as rural.
* Final numeric values are rounded to one decimal place to ensure a clean and consistent output for reporting.
* The environment is cleared at the end of the routine to maintain computational efficiency for subsequent scripts.
