...
RAW_PROVINCE_FOLDER <-  glue("{RAW_DATA_FOLDER}/nearest_facility_BC")
RAW_PROVINCE_ADDRESS_FILEPATH <- glue("{RAW_PROVINCE_FOLDER}/final_result_no_errors.csv")
RAW_PROVINCE_SUMMARY_FILEPATH <- glue("{RAW_PROVINCE_FOLDER}/final_result_no_errors_summary_stats.csv")
